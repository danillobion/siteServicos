...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <h2 class="style-font-1">Política de privacidade</h2>
            <div class="form-group">
                <div class="card">
                    <div class="card-body">
                        Política de Privacidade do vaidescermoto.com
                        Este Aplicativo recolhe alguns Dados Pessoais dos Usuários.
                        
                        Resumo da Política de privacidade
                        Os Dados Pessoais são processados para os seguintes propósitos e usando os seguintes serviços:
                        Interações baseadas na localização
                        Geolocation
                        Dados Pessoais: posição geográfica
                        
                        Política de privacidade completa
                        Proprietário e Controlador de Dados
                        Tipos de Dados coletados
                        Entre os tipos de Dados Pessoais que este Aplicativo coleta, por si mesmo ou através de terceiros, existem: posição geográfica.
